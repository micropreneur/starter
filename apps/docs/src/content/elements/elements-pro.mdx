export const meta = {
  title: 'Elements Pro',
  description: 'Understand the future authenticated registry contract without including premium source or a license gate in Starter.',
  group: 'Elements',
  order: 2,
  keywords: ['elements pro', 'premium', 'registry', 'license', 'shadcn', 'namespace'],
  sections: [
    { id: 'current-status', title: 'Current status' },
    { id: 'intended-cli-contract', title: 'Intended CLI contract' },
    { id: 'free-and-pro-stay-separate', title: 'Free and Pro stay separate' },
    { id: 'private-documentation-later', title: 'Private documentation later' },
  ],
}
