export const meta = {
  title: 'Install Elements Free',
  description: 'Browse the public registry and install source-owned components and themes with the shadcn CLI.',
  group: 'Elements',
  order: 1,
  keywords: ['elements', 'shadcn', 'registry', 'components', 'themes', 'cli'],
  sections: [
    { id: 'browse-the-registry', title: 'Browse the registry' },
    { id: 'run-it-locally', title: 'Run it locally' },
    { id: 'preview-an-item', title: 'Preview an item' },
    { id: 'install-an-item', title: 'Install an item' },
    { id: 'own-the-result', title: 'Own the result' },
  ],
}
