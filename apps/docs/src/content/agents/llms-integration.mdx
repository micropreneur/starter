export const meta = {
  ...
  description: 'Consume Starter guides as raw Markdown, concise LLM indexes, or a structured public content manifest.',
  group: 'Agents',
  order: 3,
  keywords: ['llms.txt', 'llms-full.txt', 'markdown', 'agents', 'json', 'utf-8'],
  sections: [
    { id: 'raw-markdown', title: 'Raw Markdown' },
    { id: 'llm-indexes', title: 'LLM indexes' },
    { id: 'structured-content', title: 'Structured content' },
    { id: 'generation-and-drift', title: 'Generation and drift' },
    { id: 'utf-8-contract', title: 'UTF-8 contract' },
  ],
}
