export const meta = {
  ...
  description: 'Start the web app, docs, D1 database, registry, and focused feedback loops without production secrets.',
  group: 'Getting started',
  order: 2,
  keywords: ['local development', 'pnpm dev', 'd1', 'migrations', 'tests', 'ports'],
  sections: [
    { id: 'requirements', title: 'Requirements' },
    { id: 'start-the-workspace', title: 'Start the workspace' },
    { id: 'local-service-behavior', title: 'Local service behavior' },
    { id: 'feedback-loops', title: 'Feedback loops' },
    { id: 'reset-local-d1', title: 'Reset local D1' },
  ],
}
