export const meta = {
  ...
  description: 'Find the application composition root, provider adapters, removable domain example, and source-delivered UI.',
  group: 'Getting started',
  order: 3,
  keywords: ['monorepo', 'packages', 'apps', 'architecture', 'ports adapters'],
  sections: [
    { id: 'applications', title: 'Applications' },
    { id: 'packages', title: 'Packages' },
    { id: 'where-new-code-belongs', title: 'Where new code belongs' },
  ],
}
