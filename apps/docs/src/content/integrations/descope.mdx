export const meta = {
  title: 'Descope',
  description: 'Understand the typed Descope adapter seam, its current limitations, and the work required to make it functional.',
  group: 'Integrations',
  order: 2,
  keywords: ['descope', 'auth', 'adapter', '501', 'agentic identity'],
  sections: [
    { id: 'current-status', title: 'Current status' },
    { id: 'why-the-seam-exists', title: 'Why the seam exists' },
    { id: 'implementing-the-adapter', title: 'Implementing the adapter' },
  ],
}
