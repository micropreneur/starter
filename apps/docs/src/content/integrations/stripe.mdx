export const meta = {
  ...
  description: 'Activate the complete one-plan Stripe engine or choose Starter Pro for a billing flow that is already wired.',
  group: 'Integrations',
  order: 4,
  keywords: ['stripe', 'billing', 'checkout', 'webhook', 'subscription', 'entitlement', 'starter pro'],
  sections: [
    { id: 'the-billing-engine', title: 'The billing engine' },
    { id: 'choose-an-activation-path', title: 'Choose an activation path' },
    { id: 'configure-the-sandbox', title: 'Configure the sandbox' },
    { id: 'forward-webhooks', title: 'Forward webhooks' },
    { id: 'activate-a-deployed-fork', title: 'Activate a deployed fork' },
    { id: 'verify-paid-access', title: 'Verify paid access' },
  ],
}
