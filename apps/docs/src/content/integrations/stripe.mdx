export const meta = {
  ...
  description: 'Configure the one-plan Stripe sandbox, signed webhooks, customer portal, and registry export entitlement.',
  group: 'Integrations',
  order: 4,
  keywords: ['stripe', 'billing', 'checkout', 'webhook', 'subscription', 'entitlement'],
  sections: [
    { id: 'the-billing-slice', title: 'The billing slice' },
