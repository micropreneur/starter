export const meta = {
  ...
  group: 'Cloudflare',
  order: 2,
  keywords: ['cloudflare', 'r2', 'files', 'uploads', 'presigned urls', 'avatar', 'logo', 'cors', 'lifecycle', 'rate limit'],
  sections: [
    ...
    { id: 'expire-abandoned-staging-uploads', title: 'Expire abandoned staging uploads' },
