...
export function Field({
  ...
  return (
    // biome-ignore lint/a11y/useSemanticElements: a plain div with role="group" is intentional here — a fieldset brings default styling and layout quirks and cannot be nested freely, while this wrapper must accept generic div props.
    <div
